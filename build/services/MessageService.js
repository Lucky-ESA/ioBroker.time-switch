  ...
  async handleMessage(message) {
    ...
    switch (message.command) {
      ...
      case "enable-schedule":
        ...
        await this.stateService.setState(import_main.TimeSwitch.getEnabledIdFromScheduleId(data.dataId), true);
        break;
      case "disable-schedule":
        schedule.setEnabled(false);
        await this.stateService.setState(import_main.TimeSwitch.getEnabledIdFromScheduleId(data.dataId), false);
        break;
