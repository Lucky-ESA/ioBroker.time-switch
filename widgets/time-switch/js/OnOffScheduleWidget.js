(async () => {
    class OnOffScheduleWidget extends HTMLElement {
        ...
        rename() {
            this.sr.querySelector(`#manual-on`).textContent = vis.binds["time-switch"].translate(
                "allOn",
                this.getAttribute("widgetid"),
            );
            this.sr.querySelector(`#manual-off`).textContent = vis.binds["time-switch"].translate(
                "allOff",
                this.getAttribute("widgetid"),
            );
        }
            ...
            shadowRoot.innerHTML = `
				...
				<div class="widget">
					...
					<div class="manual-container multiple" style="display: none;">
						...
						<button class="material-button" id="manual-on"><div id="manual-on-value">${vis.binds["time-switch"].translate("allOn")}</div></button>
						<button class="material-button" id="manual-off"><div id="manual-off-value">${vis.binds["time-switch"].translate("allOff")}</div></button>
					</div>
